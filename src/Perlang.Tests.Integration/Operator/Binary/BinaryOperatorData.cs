...
public static class BinaryOperatorData
{
    ...
    public static IEnumerable<object[]> MinusEqual_type =>
        new List<object[]>
        {
            new object[] { "12", "34", "System.Int32" },
            new object[] { "12", "-34", "System.Int32" },
    ...
    public static IEnumerable<object[]> SubtractionAssignment_unsupported_types_runtime =>
        new List<object[]>
        {
            new object[] { "4294967295", "33", "Operands must be numbers, not System.UInt32 and int" },
            new object[] { "4294967295", "4294967295", "Operands must be numbers, not System.UInt32 and System.UInt32" },
            // uint + long = validation error
            // uint + ulong = validation error
            // uint + double = validation error
            new object[] { "9223372036854775807", "2", "Operands must be numbers, not long and int" },
            new object[] { "9223372036854775807", "4294967295", "Operands must be numbers, not long and System.UInt32" },
            new object[] { "18446744073709551615", "2", "Operands must be numbers, not System.UInt64 and int" },
            new object[] { "18446744073709551616", "4294967295", "Operands must be numbers, not bigint and System.UInt32" },
    ...
    public static IEnumerable<object[]> PlusEqual_type => new List<object[]>
    {
        new object[] { "12", "34", "System.Int32" },
        new object[] { "12", "-34", "System.Int32" },
        new object[] { "-12", "34", "System.Int32" },
    ...
    public static IEnumerable<object[]> Division_type => new List<object[]>
    {
    ...
    public static IEnumerable<object[]> Multiplication_type => new List<object[]>
    {
    ...
    public static IEnumerable<object[]> Exponential_result => new List<object[]>
    {
    ...
    public static IEnumerable<object[]> Exponential_type => new List<object[]>
    {
    ...
    public static IEnumerable<object[]> Exponential_unsupported_types => new List<object[]>
    {
    ...
    public static IEnumerable<object[]> Percent_type => new List<object[]>
    {
        new object[] { "5", "3", "System.Int32" },
    ...
    public static IEnumerable<object[]> LessLess_type => new List<object[]>
    {
    ...
    public static IEnumerable<object[]> GreaterGreater_type => new List<object[]>
    {
