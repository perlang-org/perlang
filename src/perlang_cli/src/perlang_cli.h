...
public:
    ...
    static std::variant<bool, std::shared_ptr<perlang::Error>> is_alpha_numeric(char16_t c);
    static std::variant<bool, std::shared_ptr<perlang::Error>> is_digit(char16_t c, NumericTokenBase::NumericTokenBase base);
    bool is_at_end();
    char16_t advance();
    int32_t get_line();
    void advance_line();
